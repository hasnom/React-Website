...
export function GlowingEdgeCard({ 
  ...
  return (
    <div 
      className={cn(
        "relative w-full flex flex-col rounded-[1.768em]",
      ...
      style={{
        ...
        '--card-bg': 'var(--ge-card-bg)',
        '--blend': 'var(--ge-blend)',
        '--glow-blend': 'var(--ge-glow-blend)',
    ...
    >
        <style dangerouslySetInnerHTML={{__html: `
            .glowing-card-mesh-border {
                ...
                background:
                    ...
                    radial-gradient(at 80% 55%, hsla(190,100%,76%,1) 0px, transparent 50%) border-box,
                    radial-gradient(at 69% 34%, hsla(250,100%,74%,1) 0px, transparent 50%) border-box,
                    radial-gradient(at 8% 6%, hsla(160,100%,78%,1) 0px, transparent 50%) border-box,
                    radial-gradient(at 41% 38%, hsla(200,100%,64%,1) 0px, transparent 50%) border-box,
                    radial-gradient(at 86% 85%, hsla(180,100%,74%,1) 0px, transparent 50%) border-box,
                    radial-gradient(at 82% 18%, hsla(50,100%,65%,1) 0px, transparent 50%) border-box,
                    radial-gradient(at 51% 4%, hsla(15,100%,72%,1) 0px, transparent 50%) border-box,
                    linear-gradient(var(--accent) 0 100%) border-box;
            ...
            .glowing-card-mesh-bg {
                ...
                border: 1px solid transparent;
                background:
                    radial-gradient(at 80% 55%, hsla(190,100%,76%,1) 0px, transparent 50%) padding-box,
                    radial-gradient(at 69% 34%, hsla(250,100%,74%,1) 0px, transparent 50%) padding-box,
                    radial-gradient(at 8% 6%, hsla(160,100%,78%,1) 0px, transparent 50%) padding-box,
                    radial-gradient(at 41% 38%, hsla(200,100%,64%,1) 0px, transparent 50%) padding-box,
                    radial-gradient(at 86% 85%, hsla(180,100%,74%,1) 0px, transparent 50%) padding-box,
                    radial-gradient(at 82% 18%, hsla(50,100%,65%,1) 0px, transparent 50%) padding-box,
                    radial-gradient(at 51% 4%, hsla(15,100%,72%,1) 0px, transparent 50%) padding-box,
                    linear-gradient(var(--accent) 0 100%) padding-box;
                mask-image:
        ...
        <div className="relative z-10 w-full h-full bg-[var(--card-bg)] bg-no-repeat rounded-[inherit] border border-[var(--card-border)] overflow-hidden">
             {children}
        </div>
    </div>
  );
