...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[box-shadow,_color,_background-color,_border-color,_outline-color,_text-decoration-color,_fill,_stroke] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
    {
        variants: {
            variant: {
                default:
                    '[--liquid-button-background-color:var(--accent)] [--liquid-button-color:var(--text-strong)] text-white hover:text-bg-base shadow-xs',
                destructive:
                    '[--liquid-button-background-color:var(--accent)] [--liquid-button-color:var(--destructive)] text-white hover:text-white shadow-xs',
                secondary:
                    '[--liquid-button-background-color:rgba(255,255,255,0.05)] [--liquid-button-color:var(--accent)] text-text-main hover:text-white border border-white-10 backdrop-blur-md',
                glass:
                    '[--liquid-button-background-color:rgba(255,255,255,0.03)] [--liquid-button-color:var(--accent)] text-text-muted hover:text-white border border-white-10 backdrop-blur-xl',
                ghost:
                    '[--liquid-button-background-color:transparent] [--liquid-button-color:var(--accent)] text-text-muted hover:text-white',
            },
            size: {
