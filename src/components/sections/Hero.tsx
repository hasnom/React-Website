...
export function Hero() {
    ...
    return (
        <section className="min-h-screen flex items-center pt-[120px] pb-[80px] px-[5%] relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-[40px] lg:gap-[60px] w-full max-w-[1400px] mx-auto text-center lg:text-left">

                <motion.div
                    className="flex-1 max-w-full lg:max-w-[900px]"
                    initial="hidden"
                    animate="visible"
                    variants={{
                ...
                >
                    ...
                    <motion.p variants={fadeUpVariants} className="text-[17px] text-text-main max-w-[580px] leading-[1.8] mb-10 text-justify mx-auto lg:mx-0">
                        Built and scaled digital financial products that millions of people use every day. From zero-to-scale platform migrations to multi-channel banking ecosystems — Trying to turn complex banking infrastructure into seamless customer experiences, while generating billions in revenue.
                    </motion.p>
                    ...
                    <motion.div variants={fadeUpVariants} className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-2 text-text-muted text-[13px]">
                        📍 Pakistan &nbsp;·&nbsp;
                        <span className="text-gold">Open to global roles</span>
                    </motion.div>
                </motion.div>

                <motion.div
                    className="flex-shrink-0 flex justify-center items-center w-full lg:w-[400px] order-first lg:order-last mb-8 lg:mb-0 relative"
                ...
                >
                    ...
                    <motion.img
                        ...
                        style={{
                            boxShadow: "0 20px 60px rgba(0, 212, 255, 0.15), 0 10px 30px rgba(124, 92, 252, 0.1), 0 0 80px rgba(0, 212, 255, 0.08)"
                        }}
                        whileHover={{
                            y: -8,
                            scale: 1.02,
                            boxShadow: "0 30px 80px rgba(0, 212, 255, 0.25), 0 15px 40px rgba(124, 92, 252, 0.2), 0 0 100px rgba(0, 212, 255, 0.15)"
                        }}
                    />
                </motion.div>
            </div>
